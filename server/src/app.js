...
const materialIssuanceConfirmationRoutes = require('./modules/production-dept/material-issuance-confirmation/routes/materialIssuanceConfirmationRoutes');
...
app.use('/production-dept/material-issuance-confirmation', materialIssuanceConfirmationRoutes);
