...
interface MaterialUtilizationForPostingProps {
  data: any[];
  loading: boolean;
  search: string;
...
export const MaterialUtilizationForPosting: React.FC<MaterialUtilizationForPostingProps> = ({
  data,
  loading,
  search,
  onSearchChange,
  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerRow}>
        ...
        <Text style={[styles.title, { color: colors.text }]}>For Posting</Text>
        {onAddNew && (
          <TouchableOpacity
