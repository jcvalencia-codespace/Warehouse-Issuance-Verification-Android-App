...
const SUPPLIES_MODULES: ModuleCardData[] = [
  {
    id: 'issuance',
    title: 'New Supplies Issuance',
    description: 'Create new supplies issuance verification',
    icon: 'file-check-outline',
    color: 'primary',
  },
  {
    id: 'supplies-issuance-posted',
    title: 'Posted Supplies Issuance',
    description: 'View posted supplies issuance transactions',
...
export function SuppliesDeptHomeScreen({
  userName = '',
  userDepartment = '',
  onModulePress,
}: SuppliesDeptHomeScreenProps) {
      ...
      >
        <View style={{ paddingHorizontal: 16 }}>
          <View style={styles.section}>
            ...
            <ModuleGrid
              modules={SUPPLIES_MODULES.map(module => ({
                ...module,
...
export default SuppliesDeptHomeScreen;
